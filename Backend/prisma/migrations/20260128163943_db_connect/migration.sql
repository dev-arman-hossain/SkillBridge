...
-- CreateTable
CREATE TABLE "_CategoryTutors" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_CategoryTutors_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_CategoryTutors_B_index" ON "_CategoryTutors"("B");
...
-- AddForeignKey
ALTER TABLE "_CategoryTutors" ADD CONSTRAINT "_CategoryTutors_A_fkey" FOREIGN KEY ("A") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CategoryTutors" ADD CONSTRAINT "_CategoryTutors_B_fkey" FOREIGN KEY ("B") REFERENCES "TutorProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
